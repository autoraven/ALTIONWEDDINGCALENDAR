...
export default function Home() {
  ...
  const { businessName, contactEmail } = CALENDAR_CONFIG;
      ...
      <div style={{ minHeight:"100vh", background:"var(--bg)" }}>
        ...
        <main style={{ maxWidth:960, margin:"0 auto", padding:"36px 20px" }}>
          ...
          <div style={{
            ...
            <div style={{ display:"flex", gap:20, flexWrap:"wrap" }}>
              {[
                ...
                { color:"#1a8fff", label:"Sudah Dipesan", border:"1px solid rgba(255,255,255,0.5)" },
          ...
          <div className="card" style={{ overflow:"hidden", marginBottom:24 }}>
            {/* Month nav */}
            <div style={{ background:"linear-gradient(135deg, #0a4f9a, #1a8fff)", padding:"20px 32px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
              <button onClick={() => setCurrentDate(new Date(year, month-1, 1))}
                style={{ background:"rgba(255,255,255,0.15)", border:"1.5px solid rgba(255,255,255,0.3)", color:"#fff", width:36, height:36, borderRadius:8, fontSize:18, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" }}>‹</button>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(7,1fr)" }}>
              ...
              {Array.from({ length: daysInMonth }, (_, i) => i + 1).map(day => {
                ...
                const statusStyles = {
                  ...
                  conditional: { bg:"#fff0f0", dot:"#e53e3e", textColor:"#999" },
                ...
                return (
                  ...
                  >
                    <div style={{ width:26, height:26, borderRadius:6, background:isToday?"linear-gradient(135deg,#1a8fff,#0d6ecc)":"transparent", display:"flex", alignItems:"center", justifyContent:"center" }}>
            ...
            <div className="card" style={{ padding:"24px 28px", borderLeft:"4px solid var(--blue-2)", marginBottom:24 }}>
              ...
              {selectedEvents.map((e, i) => (
                <div key={i} style={{ borderTop: i > 0 ? "1px solid var(--border)" : "none", paddingTop: i > 0 ? 14 : 0 }}>
                  <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:22, marginBottom:8, color:"var(--dark)" }}>
          ...
          {/* Contact strip */}
          <div style={{ background:"var(--white)", borderRadius:12, padding:"20px 28px", border:"1px solid var(--border)" }}>
